...
export function sampleState(): QuoteState {
  return {
    ...
    foundationScope:"## Pre-Construction\nSite Cleaning\nSite Survey\nSoil Testing\nArchitectural Design\nStructural Design\nElevation Design\n## Site Setup\nLabour shed Construction\nMarking using Total Station survey\n## Excavation & Footing\n6 feet excavation (as per soil report)\n10–12 pillars (Isolated Footings)\nFooting concreting\n## Water & Structural Base\nSump in RCC — 10,000 litres\nSump concreting with waterproofing and bitumen coating\nPlinth beam 1.5 to 2 feet height, 6 inch thickness\nPlinth concreting\n## Protection & Finishing\nAnti-termite treatment (twice)\nSoil refilling and soil consolidation",
    baseRate:1951.92,
    costIncludes:"1. Architectural & Structural Services — Design, layout planning, elevation, and structural engineering calculations for safety and compliance.\n2. Dedicated Site Engineer — On-site technical supervision throughout construction.\n3. Project Manager — End-to-end project oversight, scheduling, and quality control.\n4. Project Coordinators — Day-to-day coordination between teams, vendors, and client.\n5. Labour for Curing — Skilled labour for proper concrete curing to ensure structural strength.\n6. Material Safety — Quality checks and safety measures for all materials used on site.\n7. Progress Updates — Regular WhatsApp updates on project progress.",
    specs:[
    ...
    terms:{
      freeze:"• Final architectural, structural, electrical and plumbing drawings will be frozen before execution.\n• The quoted price is based on the specifications in this document.\n• Any change requested after freeze will be treated as an upgradation, and the cost impact will be shared in writing before execution.\n• Work proceeds only after client approval of the revised cost.",
      adjust:"• If footing depth exceeds 6 feet based on soil test recommendations, additional cost will apply.\n• Soil carting beyond 100 meters from site attracts additional charges.\n• Any structural modification due to unforeseen site conditions may result in cost adjustment.\n• Increase in slab area beyond 50 sq.ft will be calculated as per actuals.\n• All cost impact will be discussed with the client and approved before execution.",
      ...
      included:"• Parapet wall (4 ft height, terrace floor)\n• Weatherproofing course (Dr. Fixit / Fosroc or equivalent)\n• Anti-termite treatment (applied twice)\n• Compound wall (5 ft height, all four sides)\n• Cover blocks\n• Chicken mesh & joint mesh at columns/electrical conduits/plumbing lines\n• Ceiling height 10'6\" clearance with 6\" slab thickness\n• Bathroom niches\n• Chajjas (based on site inputs)\n• Solar point & geyser point\n• Labour shed\n• Overhead tank room (7 ft, sized for two tanks)"
    },
    workflow:"1. Client Coordinator Allocation — Once the 2% advance is paid, a dedicated Client Coordinator will be assigned to the project.\n2. Site Survey & Soil Testing (Within 3–4 Days) — A site survey and soil test will be scheduled within 3–4 working days.\n3. Survey Report Submission — Once the survey report is ready, it will be handed over to the architect.\n4. Welcome Meeting — A welcome meeting will be scheduled with the Architect and Structural Engineer.\n- The Architect will lead the requirement gathering session.\n- The Structural Engineer will introduce themselves during this meeting.\n5. First Drawing Submission (4 Days) — After the requirement call, the first draft of floor plans will be shared within 4 working days.\n6. Design Iterations — Each iteration thereafter will be provided with a turnaround time of 48 hours.\n7. Finalization of Floor Plan — Once the floor plan is finalized:\n- The Architect will explain it to the client.\n- A confirmation will be taken in the project WhatsApp group.\n8. Structural Drawings (7 Days) — After floor plan confirmation, structural drawings will be prepared and shared within 1 week.\n9. Elevation Design (7 Days)\n- Prior to elevation design, theme references will be shared to understand the client's preferences.\n- One elevation option will be shared within 7 days after structural drawing is finalized.\n10. Project Execution Meeting (At Office) — Once structural drawings are finalized, the client will be invited to the office for a Project Execution Meeting.\n- Attendees:\n- Project Manager (with specifications)\n- Structural Engineer\n- Architect\n- Site Engineer\n- Agenda:\n- Final walkthrough of the design, structure, and specifications & Agreement Signing\n11. Change Requests During Execution\n- Any client-requested change during construction must be submitted in written form.\n- Permission must be obtained from the Project Head or Execution Head.\n- No verbal approvals will be accepted.\n12. Work Schedule\n- No construction or Design activities on Sundays, except during emergencies.\n13. Project Timeline\n- The project timeline will be shared after the foundation is completed.\n14. Weekly Progress Meetings\n- The Project Manager, along with the Site Engineer, will conduct a weekly review meeting (either in person or via Google Meet).\n- Discussion will cover progress updates and planning for the upcoming week."
  };
}
...
export function sampleStateKiran(): QuoteState {
  ...
  s.terms.included = "• BLOCK Sump (8,000L, plastered & waterproofed)\n• Overhead tank (1×2,000L triple-layer)\n• Parapet wall (4 ft, terrace floor)\n• Weatherproofing course (Dr. Fixit / Fosroc or equivalent)\n• Anti-termite treatment (applied twice)\n• Compound wall (5 ft height, four sides)\n• Cover blocks\n• Chicken mesh & joint mesh at columns/electrical conduits/plumbing lines\n• Ceiling height 10'6\" clearance with 6\" slab thickness\n• Bathroom niches\n• Chajjas (based on site inputs)\n• Solar point & geyser point\n• Labour shed\n• Overhead tank room (7 ft, sized for two tanks)";
...
export function sampleStateRavi(): QuoteState {
  ...
  s.baseRate = 1907;
  s.foundationScope = "## Pre-Construction\nSite Cleaning\nSite Survey\nSoil Testing\nArchitectural Design\nStructural Design\nElevation Design\n## Site Setup\nLabour Shed Construction\nMarking using Total Station Survey\n## Excavation & Footing\n6 Feet Excavation (As per Soil Report)\n10–12 Pillars (Isolated Footings)\nFooting Concreting\n## Water & Structural Base\nSump Concreting with Waterproofing & Bitumen Coating\nPlinth Beam – 1.5 to 2 Feet Height, 6 Inch Width\nPlinth Concreting\n## Protection & Finishing\nAnti-Termite Treatment (Twice)\nSoil Refilling & Soil Consolidation";
  s.costIncludes = "1. Architectural Services — Design, layout planning, elevation, and drawings\n2. Structural Services — Structural design and engineering calculations for safety and compliance\n3. Dedicated Site Engineer — On-site technical supervision throughout construction\n4. Project Manager — End-to-end project oversight, scheduling, and quality control\n5. Project Coordinators — Day-to-day coordination between teams, vendors, and client\n6. Labour for Curing — Skilled labour for proper concrete curing to ensure structural strength\n7. Material Safety — Quality checks and safety measures for all materials used on site";
  ...
  s.specs = [
    ...
    {id:uid(), title:"Warranty", rows:[
      ...
      {id:uid(), item:"Labour Safety", spec:"Our Responsibility Safety gear, on-site safety protocols, and insurance coverage for all labour deployed"},
      {id:uid(), item:"Material", spec:"Procurement, quality checks, storage, and safety of all construction materials on site"},
    ]},
    {id:uid(), title:"Design & Drawings", rows:[
  ...
  s.terms.included = "• Overhead tank (1×2,000L triple-layer tank)\n• Parapet wall (4 ft height, terrace floor)\n• Weatherproofing course (Dr. Fixit / Fosroc or equivalent)\n• Anti-termite treatment (applied twice)\n• Compound wall (5 ft height, four sides)\n• Cover blocks\n• Chicken mesh & joint mesh at columns/electrical conduits/plumbing lines\n• Ceiling height 10 ft 6 inch clearance with 6 inch slab thickness\n• Bathroom niches\n• Chajjas (based on client inputs)\n• Solar point & geyser point\n• Labour shed\n• Overhead tank room (7 ft, sized for two tanks)";
  s.terms.freeze = "• Drawings Freeze — Final architectural, structural, electrical, and plumbing drawings will be frozen before execution.\n• Pricing Basis — The quoted price is based on the specifications mentioned in this document.\n• Changes After Freeze — Any material change, layout modification, or addition requested after specification freeze will be treated as an upgradation.\n• Cost Impact — The cost impact of such changes will be shared in writing before execution.\n• Approval Requirement — Work will proceed only after client approval of the revised cost.\n• Purpose — This system ensures cost control and transparency throughout the construction process.";
  s.terms.adjust = "• Increase in Footing Depth — If footing depth exceeds 6 feet based on soil test recommendations from the structural engineer, additional cost will be applicable.\n• Soil Carting Distance — Soil carting beyond 100 meters from the site will attract additional charges.\n• Structural Modifications — Any structural modifications required due to unforeseen site conditions may result in cost adjustments.\n• Increase in Slab Area — Any increase in slab area beyond 50 sq.ft will be calculated as per actuals.\n• Cost Approval — Any such cost impact will be discussed with the client and approved before execution.";
